...
key_name = 'python_automation_key9'
...
img = ec2.Image('ami-0fc61db8544a617ed')
#img.name
...
print(ec2.SecurityGroup(inst.security_groups))
sg.authorize_ingress(IpPermissions=[{'FromPort': 22, 'ToPort': 22, 'IpProtocol': 'TCP', 'IpRanges': [{'CidrIp': '88.3.187.150/32'}]}])
